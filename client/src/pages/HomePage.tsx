...
const CATEGORIES: CategoryCard[] = [
  ...
  },
  {
    ...
    description:
      "Contemporary and classic English worship anthems for every gathering.",
  ...
  },
  {
    ...
    description:
      "Soulful English gospel tracks filled with hope, faith, and celebration.",
  ...
  },
  {
    ...
    title: "Myanmar Hymns",
    description:
      "Traditional hymns translated and adapted in the Myanmar language.",
    ...
    <main className="home-page">
      ...
      <section className="hero-page hero-page--home">
        <div className="hero-card">
          ...
          <p>
            Search by title, artist, or song notes, then move through results
