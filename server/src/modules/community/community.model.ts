...
const communitySubmissionSchema =
  new Schema<CommunitySubmissionPersistenceRecord>(
    {
...
export type CommunitySubmissionDocument =
  HydratedDocument<CommunitySubmissionPersistenceRecord>;
export type CommunityCommentDocument =
  HydratedDocument<CommunityCommentPersistenceRecord>;

export const CommunitySubmissionModel =
  model<CommunitySubmissionPersistenceRecord>(
    "CommunitySubmission",
