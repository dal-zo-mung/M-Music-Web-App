...
export const env = {
  ...
  authRateLimitWindowMs: readNumberEnv('AUTH_RATE_LIMIT_WINDOW_MS', 5 * 60 * 1000),
  commentRateLimitMax: readNumberEnv('COMMENT_RATE_LIMIT_MAX', 20),
  commentRateLimitWindowMs: readNumberEnv('COMMENT_RATE_LIMIT_WINDOW_MS', 15 * 60 * 1000),
  corsAllowedOrigins,
  ...
  isProduction,
  mongodbUrl: readRequiredEnv('MONGODB_URL'),
  port,
  readRateLimitMax: readNumberEnv('READ_RATE_LIMIT_MAX', 240),
  readRateLimitWindowMs: readNumberEnv('READ_RATE_LIMIT_WINDOW_MS', 15 * 60 * 1000),
  searchRateLimitMax: readNumberEnv('SEARCH_RATE_LIMIT_MAX', 120),
  searchRateLimitWindowMs: readNumberEnv('SEARCH_RATE_LIMIT_WINDOW_MS', 10 * 60 * 1000),
  ...
  submissionRateLimitWindowMs: readNumberEnv('SUBMISSION_RATE_LIMIT_WINDOW_MS', 60 * 60 * 1000),
  writeRateLimitMax: readNumberEnv('WRITE_RATE_LIMIT_MAX', 80),
  writeRateLimitWindowMs: readNumberEnv('WRITE_RATE_LIMIT_WINDOW_MS', 15 * 60 * 1000),
  ...
  supportChatRateLimitWindowMs: readNumberEnv('SUPPORT_CHAT_RATE_LIMIT_WINDOW_MS', 15 * 60 * 1000)
} as const;
