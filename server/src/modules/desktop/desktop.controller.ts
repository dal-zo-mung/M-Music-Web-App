...
export async function listPublicSongsHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function getPublicSongByIdHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function checkUpdatesHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    ...
    if (!Array.isArray(songs)) {
      res
        .status(400)
        .json({ error: "songs array is required.", success: false });
      return;
    }
...
export async function getLatestReleaseHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function getLegalHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function adminListDesktopSongsHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    const data = await adminListDesktopSongs(
...
export async function adminCreateDesktopSongHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function adminUpdateDesktopSongHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    const song = await adminUpdateDesktopSong(
...
export async function adminPublishDesktopSongHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    ...
    const song = await adminToggleDesktopSongPublish(
      String(req.params.songId),
      is_published,
    );
    res.json({
      status: true,
      message: "Song publish status updated successfully.",
      data: { song },
    });
  } catch (error) {
    next(error);
...
export async function adminDeleteDesktopSongHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function adminListCategoriesHandler(
  ...
  try {
    res.json({
      ...
      data: { categories: await adminListCategories() },
    });
  } catch (error) {
    next(error);
  }
...
export async function adminListReleasesHandler(
  _req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    res.json({
      ...
      data: { releases: await adminListReleases() },
    });
  } catch (error) {
    next(error);
  }
...
export async function adminCreateReleaseHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function adminActivateReleaseHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function adminDeleteReleaseHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function adminListLegalHandler(
  _req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    res.json({
      ...
      data: { documents: await adminListLegal() },
    });
  } catch (error) {
    next(error);
  }
...
export async function adminUpsertLegalHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    ...
    const document = await adminUpsertLegal(
    ...
    res.json({
      status: true,
      message: "Legal document upserted successfully.",
      data: { document },
    });
  } catch (error) {
    next(error);
